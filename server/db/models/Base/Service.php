...
abstract class Service implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ServiceTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ServiceTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function setLicenses(Collection $licenses, ConnectionInterface $con = null)
    {
        ...
        foreach ($licensesToDelete as $licenseRemoved) {
            $licenseRemoved->setService(null);
        }
     ...
     * @return ObjectCollection|ChildLicense[] List of ChildLicense objects
     */
    public function getLicensesJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildLicenseQuery::create(null, $criteria);
