...
abstract class License implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LicenseTableMap';
    ...
    /**
     * The value for the licenseid field.
     * @var        int
     */
    protected $licenseid;

    /**
     * The value for the licensenumber field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\License object.
     */
    ...
    /**
     * Get the [licenseid] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [licensenumber] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [licenseid] column.
     *
    ...
    /**
     * Set the value of [licensenumber] column.
     *
    ...
    public function setLicensenumber($v)
    {
        ...
        if ($this->licensenumber !== $v) {
            $this->licensenumber = $v;
            $this->modifiedColumns[LicenseTableMap::COL_LICENSENUMBER] = true;
        }
     ...
     * @return $this|\License The current object (for fluent API support)
     */
    public function setLicenseService($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->service !== $v) {
            $this->service = $v;
            $this->modifiedColumns[LicenseTableMap::COL_SERVICE] = true;
        }
    ...
    public function setLicenseUser($v)
    {
        ...
        if ($this->user !== $v) {
            $this->user = $v;
            $this->modifiedColumns[LicenseTableMap::COL_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LicenseTableMap::translateFieldName('Licenseid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->licenseid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LicenseTableMap::translateFieldName('Licensenumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->licensenumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LicenseTableMap::translateFieldName('LicenseService', TableMap::TYPE_PHPNAME, $indexType)];
            $this->service = (null !== $col) ? (int) $col : null;
    ...
    {
        if ($this->aService !== null && $this->service !== $this->aService->getServiceid()) {
            $this->aService = null;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LicenseTableMap::COL_LICENSEID)) {
            $modifiedColumns[':p' . $index++]  = 'licenseId';
        }
        if ($this->isColumnModified(LicenseTableMap::COL_LICENSENUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'licenseNumber';
        }
        if ($this->isColumnModified(LicenseTableMap::COL_SERVICE)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'licenseId':
                        $stmt->bindValue($identifier, $this->licenseid, PDO::PARAM_INT);
                        break;
                    case 'licenseNumber':
                        $stmt->bindValue($identifier, $this->licensenumber, PDO::PARAM_STR);
                        break;
                    case 'service':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setLicenseid($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setLicensenumber($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setLicenseService($arr[$keys[2]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LicenseTableMap::COL_LICENSEID)) {
            $criteria->add(LicenseTableMap::COL_LICENSEID, $this->licenseid);
        }
        if ($this->isColumnModified(LicenseTableMap::COL_LICENSENUMBER)) {
            $criteria->add(LicenseTableMap::COL_LICENSENUMBER, $this->licensenumber);
        }
        if ($this->isColumnModified(LicenseTableMap::COL_SERVICE)) {
            $criteria->add(LicenseTableMap::COL_SERVICE, $this->service);
        }
        if ($this->isColumnModified(LicenseTableMap::COL_USER)) {
    ...
    {
        $validPk = null !== $this->getLicenseid();
    ...
    /**
     * Generic method to set the primary key (licenseid column).
     *
    ...
    {
        if ($v === null) {
            $this->setLicenseUser(NULL);
        } else {
            $this->setLicenseUser($v->getUserid());
        }
    ...
    {
        if ($v === null) {
            $this->setLicenseService(NULL);
        } else {
            $this->setLicenseService($v->getServiceid());
        }
    ...
    {
        if ($this->aService === null && ($this->service !== null)) {
            $this->aService = ChildServiceQuery::create()->findPk($this->service, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aService->addLicenses($this);
             */
        }
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeLicense($this);
        }
        if (null !== $this->aService) {
            $this->aService->removeLicense($this);
        }
        $this->licenseid = null;
