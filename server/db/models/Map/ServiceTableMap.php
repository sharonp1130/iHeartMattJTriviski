...
class ServiceTableMap extends TableMap
{
     ...
     */
    const COL_SERVICEID = 'service.serviceId';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Serviceid', 'Description', ),
        self::TYPE_CAMELNAME     => array('serviceid', 'description', ),
        self::TYPE_COLNAME       => array(ServiceTableMap::COL_SERVICEID, ServiceTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('serviceId', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Serviceid' => 0, 'Description' => 1, ),
        self::TYPE_CAMELNAME     => array('serviceid' => 0, 'description' => 1, ),
        self::TYPE_COLNAME       => array(ServiceTableMap::COL_SERVICEID => 0, ServiceTableMap::COL_DESCRIPTION => 1, ),
        self::TYPE_FIELDNAME     => array('serviceId' => 0, 'description' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('serviceId', 'Serviceid', 'INTEGER', true, 32, null);
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Serviceid', TableMap::TYPE_PHPNAME, $indexType)];
    }
