...
class LicenseTableMap extends TableMap
{
     ...
     */
    const COL_LICENSEID = 'license.licenseId';

    /**
     * the column name for the licenseNumber field
     */
    const COL_LICENSENUMBER = 'license.licenseNumber';

    /**
     * the column name for the service field
     */
    const COL_SERVICE = 'license.service';
  ...
  array (
    ...
    1 => ':userId',
        ...
        $this->addRelation('Service', '\\Service', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':service',
    1 => ':serviceId',
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Licenseid', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Licenseid', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Licenseid', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(LicenseTableMap::COL_LICENSEID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(LicenseTableMap::COL_LICENSEID, (array) $values, Criteria::IN);
        }
