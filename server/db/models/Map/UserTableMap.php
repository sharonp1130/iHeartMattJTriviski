...
class UserTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('mondayStart', 'Mondaystart', 'TIME', false, null, null);
        $this->addColumn('mondayEnd', 'Mondayend', 'TIME', false, null, null);
        $this->addColumn('tuesdayStart', 'Tuesdaystart', 'TIME', false, null, null);
        $this->addColumn('tuesdayEnd', 'Tuesdayend', 'TIME', false, null, null);
        $this->addColumn('wednesdayStart', 'Wednesdaystart', 'TIME', false, null, null);
        $this->addColumn('wednesdayEnd', 'Wednesdayend', 'TIME', false, null, null);
        $this->addColumn('thursdayStart', 'Thursdaystart', 'TIME', false, null, null);
        $this->addColumn('thursdayEnd', 'Thursdayend', 'TIME', false, null, null);
        $this->addColumn('fridayStart', 'Fridaystart', 'TIME', false, null, null);
        $this->addColumn('fridayEnd', 'Fridayend', 'TIME', false, null, null);
        $this->addColumn('saturdayStart', 'Saturdaystart', 'TIME', false, null, null);
        $this->addColumn('saturdayEnd', 'Saturdayend', 'TIME', false, null, null);
        $this->addColumn('sundayStart', 'Sundaystart', 'TIME', false, null, null);
        $this->addColumn('sundayEnd', 'Sundayend', 'TIME', false, null, null);
